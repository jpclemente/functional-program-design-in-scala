...
trait GameDef {
  ...
  case class Block(b1: Pos, b2: Pos) {
     ...
     */
    def neighbors: List[(Block, Move)] = List((this.left, Left), (this.up, Up), (this.right, Right), (this.down, Down))
     ...
     */
    def isStanding: Boolean = this.b1.col == this.b2.col && this.b1.row == this.b2.row
